...
def test(model,test_loader):
    ...
    for idx, (x, y, _) in enumerate(test_loader):
        ...
        if max_result.equal(y.to(device)):
            correct+=1
...
def main():
    ...
    checkPoint=torch.load("winter-holiday\swin-transformer\Swin-Transformer-main\swin_large_patch4_window12_384_22k.pth", map_location='cpu')
